extends Node
class_name CharacterDataFactory

static func create_default_character_data() -> CharacterData:
...
static func create_player_character_data() -> CharacterData:
	var character_data = CharacterData.new()
...
static func create_merchant_character_data() -> CharacterData:
	var character_data = CharacterData.new()
	character_data.speed = 5.0
	character_data.can_move = true
	character_data.jump_force = 5.0
...
static func create_basic_enemy_character_data() -> CharacterData:
	var character_data = CharacterData.new()
...
static func create_advanced_npc_character_data() -> CharacterData:
	var character_data = CharacterData.new()
