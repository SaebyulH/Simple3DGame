...
func create_player_inventory_data() -> InventoryData:
	...
	inventory_data.ammo_boxes.append(AmmoFactory.create_revolver_ammo(64))
	inventory_data.ammo_boxes.append(AmmoFactory.create_rifle_ammo(64))
	inventory_data.ammo_boxes.append(AmmoFactory.create_grenade_ammo(64))
