...
func spawn_pickup_near_player(saveable_data: Dictionary):
	if saveable_data.has("scene_path"):
		...
		var spawn_position = player.global_position + forward * 2.0
		instance.global_position = spawn_position
		instance.global_rotation = player.global_rotation + Vector3(0, PI/2, 0)
