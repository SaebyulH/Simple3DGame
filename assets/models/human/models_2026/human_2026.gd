...
func delete_equipped_item():
	for child in $Armature/Skeleton3D/HandBone/EquippedItem.get_children():
		child.queue_free()

func get_equipped_item_position():
	return $Armature/Skeleton3D/HandBone/EquippedItem.get_child(0).global_position
	
func get_equipped_item_rotation():
	return $Armature/Skeleton3D/HandBone/EquippedItem.get_child(0).global_rotation
