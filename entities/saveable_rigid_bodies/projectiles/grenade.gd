...
#func _ready() -> void:
	#scene_path = "res://entities/saveable_rigid_bodies/projectiles/grenade.tscn"
...
func get_save_data() -> Dictionary:
	var data = super()
	data["detonation_time_left"] = detonation_time_left
	return data

func apply_save_data(data: Dictionary) -> void:
	super(data)
	if data.has("detonation_time_left"):
		detonation_time_left = data["detonation_time_left"]
